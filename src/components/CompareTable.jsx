...
const plansData = {
  en: [
    { key: 'starter', name: 'Challenger', price: 'Free', sub: 'For individuals getting started', popular: false },
    { key: 'pro', name: 'Champion', price: 'Available Soon', sub: 'For growing organizers', popular: true },
    { key: 'elite', name: 'Premier (Custom)', price: 'Available Soon', sub: 'For organizations & federations', popular: false },
  ],
  ar: [
    { key: 'starter', name:' المتحدي', price: 'مجاني', sub: 'للأفراد الذين يبدؤون للتو', popular: false },
    { key: 'pro', name: 'البطل', price: 'قريباً', sub: 'للمنظمين في مرحلة النمو', popular: true },
    { key: 'elite', name: 'النخبة (مخصص)', price: 'قريباً', sub: 'للمنظمات والاتحادات', popular: false },
  ],
};
  ...
  ar: [
    {
      ...
      features: [
        { name: 'البطولات', starter: 'حتى 8 فرق / 32 لاعب', pro: 'غير محدود', elite: 'غير محدود' },
        { name: 'الدوريات', starter: false, pro: true, elite: true },
        { name: 'مباريات ودية وتدريب', starter: 'غير محدود', pro: 'غير محدود', elite: 'غير محدود' },
        { name: 'الصيغ (إقصائي، مجموعات، مختلط)', starter: 'أساسي', pro: 'متقدم', elite: 'متقدم' },
        { name: 'التأهيل والقرعة التلقائية', starter: false, pro: true, elite: true },
        { name: 'جدولة المباريات', starter: 'أساسي', pro: 'تلقائي', elite: 'تلقائي' },
        { name: 'النتائج المباشرة', starter: false, pro: true, elite: true },
        { name: 'الترتيب المباشر والنهائي', starter: false, pro: true, elite: true },
      ]
    },
    {
      title: 'التسجيل والمشاركون',
      features: [
        { name: 'إدارة المشاركين', starter: 'أساسي', pro: 'متقدم', elite: 'متقدم' },
        { name: 'أنواع التسجيل', starter: 'فردي / فريق', pro: 'فردي / فريق / مختلط', elite: 'مرونة كاملة' },
        { name: 'نشر الفعاليات في التطبيق', starter: 'أساسي', pro: 'مميز', elite: 'أولوية' },
      ]
    },
    {
      title: 'المدفوعات والتحقيق المالي',
      features: [
        { name: 'تحصيل المدفوعات', starter: 'أساسي (عبر الإنترنت)', pro: 'متكامل', elite: 'متقدم + مخصص' },
        { name: 'دمج الدفع الشخصي', starter: false, pro: 'إضافة / مدمج', elite: true },
        { name: 'أدوات الرعاية', starter: false, pro: false, elite: true },
        { name: 'التحليلات والإحصاءات', starter: false, pro: 'أساسي', elite: 'متقدم' },
      ]
    },
    {
      title: 'العلامة التجارية والمنصة',
      features: [
        { name: 'العلامة التجارية', starter: false, pro: 'أساسي (شعار، ألوان)', elite: 'كاملة (white-label)' },
        { name: 'نطاق مخصص', starter: false, pro: false, elite: true },
        { name: 'علامة تطبيق الجوال', starter: false, pro: false, elite: 'تطبيق مخصص' },
        { name: 'وصول متعدد المسؤولين', starter: false, pro: 'محدود', elite: 'متقدم' },
        { name: 'إدارة متعددة المنظمات', starter: false, pro: false, elite: true },
      ]
    },
    {
      title: 'الدعم',
      features: [
        { name: 'مستوى الدعم', starter: 'عادي', pro: 'أولوية', elite: 'مخصص' },
      ]
    },
  ],
};
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-4xl">
        ...
        {/* ── Header — aligné sur le style de Pricing ─────────── */}
        <motion.div
        ...
        >
          <span
            className="font-heading inline-block text-xs uppercase tracking-[0.2em] font-bold px-4 py-1.5 rounded-full mb-5"
            style={{
...
>
          ...
          <p className="font-heading text-xl sm:text-2xl text-primary font-semibold mb-6">
            {isRTL ? 'قارن بسهولة واختر بثقة' : 'Compare with clarity, choose with confidence'}
          </p>
